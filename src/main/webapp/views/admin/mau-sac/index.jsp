...
<a href="/admin/mau-sac/create" class="btn btn-danger col-1">Thêm mới</a>
<table class="table mt-4">
    ...
    <c:forEach items="${ data.content }" var="nv">
        <tr>
            ...
            <td> ${ nv.ten }</td>
            <td>
                <a class="btn btn-success" href="/admin/mau-sac/edit/${nv.id}">Cập nhật</a>
            </td>
            <td>
                <a class="btn btn-primary" href="/admin/mau-sac/delete/${nv.id}">Xóa</a>
            </td>
        </tr>
    </c:forEach>
    </tbody>
